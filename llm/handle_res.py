...
from ..util import PostComments, load_post_comments, save_post_comments, CommentInfo, PostCommentsInfo, Comment, sentiment_choice

work_dir = os.path.dirname(__file__)
with open(f"{work_dir}/emotion_new_cache5.json", "r", encoding="utf-8") as f:
    emotion = json.load(f)
