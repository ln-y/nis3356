...
from ..util import PostComments, load_post_comments, save_post_comments, CommentInfo, PostCommentsInfo, Comment, sentiment_choice, view_choice
    ...
    for pkli in tqdm(pkl_lst):
        if pkli.endswith(".pkl"):
            ...
            for ind, comment in enumerate(post_comments):
                ...
                viewi = views[key]
                out_comments.append(CommentInfo(emotioni, viewi, comment))
