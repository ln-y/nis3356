...
if __name__ == "__main__":
    input_directory = r"bilibili\processed_data\json"  # 指定存放 JSON 文件的目录
    output_directory = r"event_phase_segement\bilibili\weekly_details"  # 每周评论的 JSON 文件存放目录
    overview_file_path = r"event_phase_segement\bilibili\weekly_stats.json"  # 总览统计结果文件路径
